...
//   // for version over 3.5 need to turn uSUP ON
  ...
  pinMode(anemometer_pin, INPUT_PULLUP);  // Set GPIO 4 as input with pull-up
  attachInterrupt(digitalPinToInterrupt(anemometer_pin), countFallingEdge, CHANGE);  // Attach interrupt for falling edge
}
